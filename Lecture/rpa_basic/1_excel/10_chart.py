...
from openpyxl.chart import BarChart, Reference, bar_chart, LineChart
# B2:C11 까지의 데이터를 차트로 생성
bar_value = Reference(ws, min_row=2, max_row=11, max_col=3)
bar_chart = BarChart() # 차트 종류 생성(Bar, Line, Pie,...)
bar_chart.add_data(bar_value) # 차트 데이터 추가

ws.add_chart(bar_chart, "E1") #차트 넣을 위치 정의

# B1:C11 까지의 데이터
line_value = Reference(ws, min_row=1, max_row=11, max_col=3)
